...
class Conveyer extends Component<ConveyerEvents> {
  ...
  public updateContainer() {
    ...
    this._size = horizontal ? scrollAreaElement.clientWidth : scrollAreaElement.clientHeight;
    this._scrollSize = horizontal ? scrollAreaElement.scrollWidth : scrollAreaElement.scrollHeight;
    this._refreshScroll();
    this._onScroll();
  }
  /**
  ...
  private _refreshScroll() {
    const horizontal = this._options.horizontal;
    const scrollAreaElement = this._scrollAreaElement;
    this._pos = horizontal ? scrollAreaElement.scrollLeft : scrollAreaElement.scrollTop;
  }

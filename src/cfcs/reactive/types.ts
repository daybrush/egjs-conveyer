...
export type ReactiveEventParameters<
  ...
  EventName extends EventKey<Events>,
  THIS = any> = UnknwonToAnyArray<Parameters<ReactiveEventCallback<Events, EventName, THIS>>>;
...
export type ReactiveAdapter<
  ...
  > = {
    ...
    on?: <EventName extends EventKey<Events>>(
      instance: Instance, eventName: EventName, listener: ReactiveEventCallback<Events, EventName, any>) => void;
